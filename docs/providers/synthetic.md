---
summary: "Use Synthetic's Anthropic-compatible API in Synurex"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. Synurex registers it as the
...
Note: Synurex's Anthropic client appends `/v1` to the base URL, so use

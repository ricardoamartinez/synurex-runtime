...
You can point Synurex at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Synurex
...
- [Anthropic provider](/providers/anthropic) - Native Synurex integration with Claude setup-token or API keys

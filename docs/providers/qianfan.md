---
summary: "Use Qianfan's unified API to access many models in Synurex"
read_when:
...
3. Synurex installed on your system
...
4. Copy the API key for use with Synurex

## CLI setup

```bash
Synurex onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Synurex Configuration](/gateway/configuration)

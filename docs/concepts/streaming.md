...
Synurex has two separate “streaming” layers:
...
When block streaming is enabled, Synurex can **merge consecutive block chunks**
...
When draft streaming is active, Synurex disables block streaming for that reply to avoid double-streaming.

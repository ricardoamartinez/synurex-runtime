...
- Install via CLI: `Synurex plugins install @Synurex/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `Synurex plugins install ./extensions/zalo`
   - From npm (if published): `Synurex plugins install @Synurex/zalo`
...
- Approve via:
  - `Synurex pairing list zalo`
  - `Synurex pairing approve zalo <CODE>`
...
- Example: `Synurex message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `Synurex channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `Synurex logs --follow`

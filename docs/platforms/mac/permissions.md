...
- Same path: run the app from a fixed location (for Synurex, `dist/Synurex.app`).
...
Workaround: move files into the Synurex workspace (`~/.synurex/workspace`) if you want to avoid per-folder grants.

...
Deploy SYNUREX on Railway with a one-click template and finish setup in your browser.
...
<a href="https://railway.com/deploy/Synurex-railway-template" target="_blank" rel="noreferrer">
  Deploy on Railway
</a>
...
- `https://<your-railway-domain>/SYNUREX` — Control UI

## What you get

- Hosted SYNUREX Gateway + Control UI
...
- `SYNUREX_STATE_DIR=/data/.SYNUREX` (recommended)
- `SYNUREX_WORKSPACE_DIR=/data/workspace` (recommended)
- `SYNUREX_GATEWAY_TOKEN` (recommended; treat as an admin secret)
...
This exports your SYNUREX state + workspace so you can migrate to another host without losing config or memory.

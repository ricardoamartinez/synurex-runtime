...
import type { SynurexConfig, ReplyToMode, TelegramAccountConfig } from "../config/types.js";
...
async function resolveStickerVisionSupport(cfg: SynurexConfig, agentId: string) {
  try {

...
function resolveAvatarSource(cfg: SynurexConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: SynurexConfig, agentId: string): AgentAvatarResolution {

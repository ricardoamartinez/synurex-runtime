...
function resolveWatchPaths(workspaceDir: string, config?: SynurexConfig): string[] {
  const paths: string[] = [];
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: SynurexConfig }) {

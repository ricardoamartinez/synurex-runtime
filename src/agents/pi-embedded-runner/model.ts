...
// pi-ai's built-in Anthropic catalog can lag behind Synurex's defaults/docs.
...
export function buildModelAliasLines(cfg?: SynurexConfig) {
...
export function resolveModel(
  ...
  const resolvedAgentDir = agentDir ?? resolveSynurexAgentDir();

...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "Synurex-update-check-"));
    process.env.SYNUREX_STATE_DIR = tempDir;
  ...
  it("logs update hint for npm installs when newer tag exists", async () => {
    const { resolveSynurexPackageRoot } = await import("./Synurex-root.js");
    ...
    vi.mocked(resolveSynurexPackageRoot).mockResolvedValue("/opt/Synurex");

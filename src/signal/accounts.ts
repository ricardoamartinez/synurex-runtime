...
export function listSignalAccountIds(cfg: SynurexConfig): string[] {
...
export function resolveDefaultSignalAccountId(cfg: SynurexConfig): string {
...
function mergeSignalAccountConfig(cfg: SynurexConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: SynurexConfig): ResolvedSignalAccount[] {

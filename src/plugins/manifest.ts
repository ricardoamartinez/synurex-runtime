...
export const PLUGIN_MANIFEST_FILENAME = "skykoi.plugin.json";
...
// package.json "SKYKOI" metadata (used for onboarding/catalog)
...
export type SKYKOIPackageManifest = {
  extensions?: string[];
...
): SKYKOIPackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }

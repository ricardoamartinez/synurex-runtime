## SYNUREX Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_SYNUREX-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm SYNUREX gateway --port 18789 --verbose
```

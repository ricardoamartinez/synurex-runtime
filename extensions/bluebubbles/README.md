...
This directory contains the **BlueBubbles external channel plugin** for Synurex.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `Synurex/plugin-sdk` helpers.

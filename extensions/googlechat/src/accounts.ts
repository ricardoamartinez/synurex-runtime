...
export function listGoogleChatAccountIds(cfg: SynurexConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: SynurexConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: SynurexConfig): ResolvedGoogleChatAccount[] {

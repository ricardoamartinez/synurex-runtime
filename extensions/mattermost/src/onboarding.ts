import type { ChannelOnboardingAdapter, SynurexConfig, WizardPrompter } from "Synurex/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.synurex.ai/channels/mattermost",
    ].join("\n"),

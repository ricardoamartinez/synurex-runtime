...
export function listMattermostAccountIds(cfg: SynurexConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: SynurexConfig): string {
...
export function listEnabledMattermostAccounts(cfg: SynurexConfig): ResolvedMattermostAccount[] {

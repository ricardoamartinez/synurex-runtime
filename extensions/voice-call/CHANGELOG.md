...
- Version alignment with core Synurex release numbers.
...
- First public release of the @Synurex/voice-call plugin.
...
- CLI: `Synurex voicecall` commands (call/start/continue/speak/end/status/tail/expose).
